// Continue the timer from math.js
...
// Back button to navigate to the last question in math.html
const prevBtn = document.getElementById("prevBtn");
if (prevBtn) {
  prevBtn.addEventListener("click", () => {
    // Set current question to the last question and navigate to math.html
