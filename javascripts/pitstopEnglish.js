// Continue the timer from sat.js
  ...
  timerInterval = setInterval(() => {
    if (!isPaused && timeLeft > 0) {
      ...
      if (timeLeft === 0) {
        ...
        // redirect user to break timer page
...
// Back button to navigate to question 27 in bluesat.html
const prevBtn = document.getElementById("prevBtn");
if (prevBtn) {
  prevBtn.addEventListener("click", () => {
    // Set current question to 27 and navigate to bluesat.html
    sessionStorage.setItem("currentQuestion", 27);
    window.location.href = "bluesat.html";
  });
}
